...
class LFUCache(BaseCaching):
    """
    Caching Class which allows storing with  a LFU removal mechanism when the
    maximum item set is reached.
    """
    ...
    def __reorder_items(self, mru_key):
        """
        Reorders the cache based on the most recently used item.
        """
        max_positions = []
        mru_freq = 0
        mru_pos = 0
